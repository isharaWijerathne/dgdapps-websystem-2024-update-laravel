...
<body>
  ...
  <div class=" ">
    <p class=" m-3 text-blue-600 text-2xl  font-bold">News List</p>
  </div>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
              <thead>
                <tr>
                  ...
                  <th scope="col" class="px-6 py-3 text-end text-xs font-medium text-gray-500 uppercase dark:text-neutral-500">News Card Header</th>
              ...
              <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                ...
                @foreach ($news as $item)
                  <tr>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200">{{ $item->news_id }}</td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200">{{ $item->news_card_header }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-200">
                      {!! $item->body !!}
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200">{{ $item->create_time }}</td>
