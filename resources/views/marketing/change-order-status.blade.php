...
<body>
  ...
  <div class=" ">
    <p class=" m-3 text-blue-600 text-2xl  font-bold">Change Order Status</p>
  </div>
  ...
  <div class="grid grid-cols-4 m-3 gap-2 bg-slate-100 rounded-md p-2">
    ...
    <div class="col-span-3 p-1">
        ...
        <button type="submit" class="bg-blue-500 rounded-lg text-white mt-2 p-2" href="http://" target="_blank" rel="noopener noreferrer">Change Order Status</button>
    </div>
